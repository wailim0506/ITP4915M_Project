...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2024 at 06:57 PM
...
('LMC00001', 'Peter', 'Zhang', 'F', 'peter.zhang@abc.com', 'AutoTech Solutions', '13012345678', 'Gansu', 'Jinchang', '23 South Avenue', 'No. 35, Square South Road, Lanzhou, Gansu', '2001-05-23', 'AmericanEx', NULL, '2000-02-02', '456 West Street'),
('LMC00002', 'Lily', 'Li', 'F', 'lily.li@example.com', 'Legend Motor Limited Company', '13098765432', 'Sichuan', 'Chengdu', '48/F, Office Tower 2, Chengdu IFS, No.1, Section 3', 'No. 2, Section 2, Renmin South Road, Wuhou Distric', '2023-08-10', 'MasterCard', NULL, '2024-05-23', '123 Main Street'),
('LMC00003', 'Michael', 'Wang', 'M', 'michael.wang@example.com', 'Global Auto Spares', '13087654321', 'Beijing', 'Beijing', '789 East District', 'No. 8, Yongdingmen East Street, Dongcheng District', '2021-11-15', 'Visa', NULL, NULL, ''),
('LMC00004', 'Wendy', 'Chen', 'F', 'wendy.chen@example.com', 'Premier Motorsupply', '13021654987', 'Shanghai', 'Shanghai', '1 Pudong New Area', 'No. 301, Zhaojiabang Road, Shanghai', '2022-05-20', 'UnionPay', NULL, NULL, '');
...
('OD24020001', 'CA00001', 'SA00006', 'SN24020001', '2024-02-11', NULL, 'Shipped', NULL, NULL, 9),
...
INSERT INTO `product` (`itemID`, `category`, `partNumber`, `onSaleQty`, `LM_onSaleQty`, `description`, `price`, `imageID`, `multiMediaID`) VALUES
('LMP00001', 'A', 'A00001', 297, 500, 'Elevate the appearance of your car with our premium tinned plate cover. Crafted from high-quality metals, this cover adds a touch of elegance and a polished, reflective finish to your vehicle exterior. Designed for a seamless fit, it enhances the overall aesthetics while protecting your car surface from minor scratches and weathering.', 500, NULL, NULL),
('LMP00002', 'A', 'A00002', 497, 700, 'Enhance the style and protection of your car doors with our custom door covers. Crafted from durable materials, these covers seamlessly integrate with your vehicle design, offering a sleek and modern appearance. Safeguard your doors from scratches, dings, and environmental elements, while adding a personalized touch to your car exterior.', 800, NULL, NULL),
('LMP00003', 'A', 'A00003', 197, 300, 'Enhance the style and protection of your car doors with our custom door covers. Crafted from durable materials, these covers seamlessly integrate with your vehicle design, offering a sleek and modern appearance. Safeguard your doors from scratches, dings, and environmental elements, while adding a personalized touch to your car exterior.', 1000, NULL, NULL),
('LMP00004', 'A', 'A00004', 299, 400, 'Enhance your car look with our stylish and protective hood cover. Crafted from durable materials, it offers a custom fit to shield your vehicle hood from weather and minor damage, elevating your driving experience.', 360, NULL, NULL),
('LMP00005', 'A', 'A00005', 249, 400, 'Our premium trunk lid adds a sleek, modern touch to your car. Crafted from high-quality materials, it seamlessly integrates with your vehicle design, offering a custom fit and enhanced protection for your trunk area. Elevate your car style with this versatile and functional accessory.', 214, NULL, NULL),
('LMP00006', 'B', 'B00001', 849, 1000, 'Optimize your car engine cooling with our advanced cooling system cover. Designed to improve airflow and heat dissipation, this cover ensures efficient engine operation, reducing the risk of overheating and prolonging the lifespan of your vehicle vital components.', 440, NULL, NULL),
('LMP00007', 'B', 'B00002', 999, 1500, 'Unveil the power within your car with our engine disassembly cover. This transparent cover allows you to see the intricate workings of your engine, perfect for enthusiasts and mechanics. Crafted with durable materials, it provides a clear view while protecting the engine components during maintenance and repairs.', 700, NULL, NULL),
('LMP00008', 'B', 'B00003', 430, 600, 'Enhance the performance of your car with our precision-engineered gear cover. Crafted from high-strength materials, this cover safeguards your gearbox components from wear, tear, and environmental factors, ensuring smooth and efficient power transmission. Elevate your driving experience with this functional and durable accessory.', 500, NULL, NULL),
('LMP00009', 'B', 'B00004', 430, 700, 'Showcase the braking power of your car with our stylish brake caliper covers. Designed to fit over your vehicle brake calipers, these covers not only enhance the visual appeal but also help protect the calipers from the elements. Available in a range of colors, they add a personalized touch to your ride.', 560, NULL, NULL),
('LMP00010', 'B', 'B00005', 500, 900, 'Protect the heart of your car air suspension system with our rugged compressor cover. Crafted from durable materials, this cover shields your air suspension compressor from dust, debris, and environmental factors, ensuring reliable performance and extended lifespan. Elevate your driving experience with this functional and discreet accessory.', 145, NULL, NULL),
...
('LMSC0001', 'LMP00001', 2, '22/06/2024'),
...
('OD24020001', 'LMD001', '2024-03-01', NULL, 'EN0001', 'No. 8, Yongdingmen East Street, Dongcheng District'),
...
INSERT INTO `spare_part` (`partNumber`, `supplierID`, `categoryID`, `name`, `reorderLevel`, `dangerLevel`, `quantity`) VALUES
('A00001', 'SIDIN00001', 'A', 'Tinned Plate', 100, 50, 799),
...
('LMS00002', 'LMD03', 'Mei', 'Wong', 'F', 'mei.wong@example.com', '09876543210', '1985-09-20', 'Order Processing Clerk', NULL, NULL),
('LMS00003', 'LMD02', 'Wai', 'Chan', 'M', 'wai.chan@example.com', '02468013579', '1978-02-28', 'Purchasing Staff', NULL, NULL),
('LMS00004', 'LMD04', 'Ling', 'Lam', 'F', 'ling.lam@example.com', '13579024680', '1990-11-05', 'Goods Inward Staff', NULL, NULL),
...
('LMS00007', 'LMD03', 'Fiona', 'Chen', 'F', 'fiona.chen@example.com', '09876543212', '1990-07-28', 'Order Processing Clerk', NULL, NULL),
...
('SA00002', 'LMS00002', 'active', '$2a$11$ROw0TLKZTVkyjIo9no3UX.4xVlsyNy4B4aUiHCD76XVCcQhFchEkq', '2024-05-02', '2024-05-13'),
...
('SA00005', 'LMS00005', 'active', '$2a$11$YAwMphVbJYlIdllgZ3k1x.xRm7rkRhoNnJvqrnKenO.DAZesAtfrW', '2024-05-15', '2024-05-10'),
('SA00006', 'LMS00006', 'active', '$2a$11$7FgtPouKfa86CTPpaxg3vekIG9joziut1WBIl20MGpv1shzp.NOTa', '2024-06-04', '2024-06-16'),
('SA00007', 'LMS00007', 'active', '$2a$11$jShG/jYvl1Bk3YXMjskzXONmRqFFpjM9OYzsRPpQpzB9ziLDrb6Q.', '2024-06-03', '2024-06-17'),
('SA00008', 'LMS00008', 'active', '$2a$11$o4InuCLpWHC4UqqDxqr3xuws2J7mhFkcLW076ZXzpOJkoB0P8sCQO', '2024-06-04', '2024-06-04'),
('SA00009', 'LMS00009', 'active', '$2a$11$ymoTOnGOpa4ecldl5b0DyeHmr7Gan2yS4YBeEwMWaEW3gkiI8JSii', '2024-06-01', '2024-06-01'),
('SA00010', 'LMS00010', 'active', '$2a$11$8rST.7FvIsNHVTvn1r1x0uIbwanvzGVGiDGGeG1dWxmTMXpRDWbty', '2024-06-03', '2024-06-03'),
('SA00011', 'LMS00011', 'active', '$2a$11$CKaxvDzZSq9bt46RL7sOJ.wYgy5PrcKRoH7CN91d1v.8OBUd7pOya', '2024-06-04', '2024-06-04');
...
INSERT INTO `supplier` (`supplierID`, `name`, `phone`, `address`, `country`) VALUES
('SIDBR00001', 'Metalúrgica RIOSULENSE S.A.', '+55-4735211200', 'Rua Campos Salles, 1000 - Centro, Rio do Sul - SC, 89160-000', 'Brazil'),
('SIDCN00001', 'Guangzhou Jincheng Auto Group', '+86-208765 4321', 'No. 456, Guangzhou Avenue, Guangzhou', 'China'),
('SIDCN00002', 'BYD Auto Co., Ltd.', '+86-75589888888', 'BYD Road, Pingshan District, Shenzhen, Guangdong', 'China'),
...
('SIDUK00001', 'Halfords Group PLC', '+44-03332001003', 'Icknield Street Drive, Washford, Redditch B98 0DE', 'United Kingdom'),
('SIDUK00002', 'Euro Car Parts', '+44-02082313000', '1 Racecourse Industrial Estate, Uxbridge UB8 2LJ', 'United Kingdom'),
('SIDUK00003', 'Febi Bilstein UK Ltd.', '+44-01227374724', 'Gateway Business Park, Vauxhall Industrial Estate, Ruislip HA4 6QD', 'United Kingdom'),
('SIDUS00001', 'AutoZone, Inc.', '+1-9014956500', '123 South Front Street, Memphis, TN 38103', 'United States'),
('SIDUS00002', 'Reilly Auto Parts', '+14178623333', '233 S Patterson Ave, Springfield, MO 65802', 'United States');
